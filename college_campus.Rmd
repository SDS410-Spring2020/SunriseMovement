...
```{r}
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Caucasian" = "White")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Uncoded" = "Unknown")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Other" = "POC")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "African-American" = "POC")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Asian" = "POC")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Hispanic" = "POC")
full_data$vb_voterbase_race <- recode(full_data$vb_voterbase_race, "Native American" = "POC")
...
counts <- clean_data %>%
  group_by(activistcodename.y, vb_voterbase_race)%>%
