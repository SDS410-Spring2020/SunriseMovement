...
```{r demographic_state}
#Iowa
base_plot(data = filter(unique_matched, vb_tsmart_state == "IA"), title = "Iowa")

#New Hampshire
base_plot(data = filter(unique_matched, vb_tsmart_state == "NH"), title = "New Hampshire")

#Pennsylvania
base_plot(data = filter(unique_matched, vb_tsmart_state == "PA"), title = "Pennsylvania")

#M
base_plot(data = filter(unique_matched, vb_tsmart_state == "MA"), title = "Massachusetts")
```
