...
```{r}
college_dems_in_state$college_type <- recode(college_dems_in_state$college_type, "Private not-for-profit, 4-year or above" = "Private, 4 Year (+)")
```
...
ggplot(college_dems_in_state, 
  ...
  labs(title="Percent of In-State Students by College Type and State", fill = "College Type")+
  xlab("College Type")+
